# -*- coding: utf-8 -*-
"""neuralmind/bert-base-portuguese-cased.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-FGworUr62aRo66NdwBeXMKTEvrd8rt1
"""
...
df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Dados/dataset-petitions-legal-br.csv')
...
# Tokenizer com neuralmind/bert-base-portuguese-cased
...
# Tokenizar os textos usando o tokenizer BERTimbau Base
...
best_model_dir = "/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Melhor-modelo"
...
csv_file_path = '/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Training-Metrics/training_metrics.csv'
...
out_dir = '/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Modelo-treinado-tokenizer-e-perdas-em-arquivos'
...
def compute_additional_metrics(y_true, y_pred, y_probs, average='weighted'):
    ...
    try:
        ...
        # One-hot de y_true com shape compatível a y_probs
        num_classes = y_probs.shape[1]
        y_true_bin = pd.get_dummies(y_true)
        y_true_bin = y_true_bin.reindex(columns=range(num_classes), fill_value=0).values.astype(np.int64)

        # AUC-ROC e AUC-PR
        metrics["AUC-ROC"] = roc_auc_score(y_true_bin, y_probs, average=average, multi_class='ovr')
        metrics["AUC-PR"] = average_precision_score(y_true_bin, y_probs, average=average)

    except Exception as e:
        print(f"[Aviso] Erro ao calcular AUC/MCC: {e}")
        metrics["MCC"] = metrics.get("MCC", None)
...
# SALVAR COMO ARQUIVO
# ---------------------
val_csv_file_path = '/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Relatório-de-classificação-para-validação/Val_Classification_Report.csv'
test_csv_file_path = '/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Relatório-de-classificação-para-teste/Test_Classification_Report.csv'
...
model_path = '/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Modelo-treinado-tokenizer-e-perdas-em-arquivos'
data_path = '/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Dados/dataset-petitions-legal-br.csv'
...
confusion_df.to_csv('/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Inferência/matriz_de_confusao.csv')
sorted_report_all.to_csv('/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Inferência/relatorio_classificacao_categorias_com_resultados.csv')
weighted_avg_metrics.to_frame().T.to_csv('/content/drive/MyDrive/Colab Notebooks/Defesa final/Modelos BERT/neuralmind bert-base-portuguese-cased/Inferência/Inferência_gerais.csv')